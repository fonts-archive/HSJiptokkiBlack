...
[배포처 바로가기](https://blog.naver.com/hp0/222605164754)

&nbsp;

## 웹 폰트

사용하는 `font-family`의 이름은 `HSJiptokki Black`입니다.
...
@font-face {
    ...
    src: url('https://cdn.jsdelivr.net/gh/fonts-archive/HSJiptokkiBlack/HSJiptokkiBlack.woff2') format('woff2'),
         ...
         url('https://cdn.jsdelivr.net/gh/fonts-archive/HSJiptokkiBlack/HSJiptokkiBlack.otf') format('opentype'),
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/HSJiptokkiBlack/subsets/HSJiptokkiBlack-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/HSJiptokkiBlack/subsets/HSJiptokkiBlack-dynamic-subset.css');
```
...
```css
font-family: "HSJiptokki Black", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
